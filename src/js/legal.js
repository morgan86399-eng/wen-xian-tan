/**
 * Zenasker · 法律合規與特約商店審查條款模組 (Terms, Privacy & Refund Policy)
 * 供金流服務商審查與使用者權益維護
 */
...
export const LEGAL_DOCS = {
  terms: {
    ...
    content: `
      <div class="legal-doc-content">
        ...
        <h3>四、 交易與金流安全</h3>
        <p>本平台之線上金流交易均委託具備法定資格之第三方金流服務商處理，實際合作對象將於收款開放時於本頁公告。本平台絕不保留、側錄或儲存任何使用者的信用卡卡號、有效期限或安全碼。</p>
  ...
  privacy: {
    ...
    content: `
      <div class="legal-doc-content">
        <h3>一、 個人資料之蒐集原則</h3>
        <p>Zenasker極度重視您的隱私權。我們僅在為您提供命理分析服務之必要範圍內，蒐集您主動輸入的性別、年齡區間、祈請關係角色與請教問題。</p>
        ...
        <h3>四、 第三方金流資料傳輸</h3>
        <p>當您發起結帳時，系統將透過 SSL 256-bit 高規格加密通道將訂單金額與交易識別號傳送至金流服務商之安全收銀台，以確保交易資訊於傳輸過程中之機密與完整。</p>
      </div>
    `
  },
