...
export const THEME_SKELETONS = {
  love: ['這段關係真正卡住的地方', '對方沒有說出來的那一面', '適合主動或等待的時機', '接下來可以自己驗證的跡象'],
  work: ['你現在最該注意的事', '你的優勢與還沒補上的那一塊', '這一段路的節奏建議', '接下來可以自己驗證的跡象'],
  career: ['目前局勢的關鍵判斷', '金流與合作關係的隱憂', '這個階段最優先要做的事', '收手或加碼的判斷點'],
  wealth: ['你的正財與偏財傾向', '錢最容易流掉的地方', '守成與開源的先後順序', '大額決策的時機判斷'],
  family: ['這件事的核心矛盾在哪', '衝突最常被觸發的原因', '一次處理一件事的優先順序', '需要外人協助的界線'],
  children: ['孩子目前最需要的是什麼', '互動方式要調整的地方', '家庭與學校可以觀察的項目', '需要專業協助的警訊']
};
